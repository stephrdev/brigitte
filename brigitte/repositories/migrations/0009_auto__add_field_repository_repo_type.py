...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Repository.repo_type'
        db.add_column('repositories_repository', 'repo_type', self.gf('django.db.models.fields.CharField')(default='git', max_length=4), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Repository.repo_type'
        db.delete_column('repositories_repository', 'repo_type')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Repository.private'
        db.add_column('repositories_repository', 'private', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Repository.private'
        db.delete_column('repositories_repository', 'private')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Repository.path'
        db.delete_column('repositories_repository', 'path')


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Repository.path'
        raise RuntimeError("Cannot reverse this migration. 'Repository.path' and its values cannot be restored.")

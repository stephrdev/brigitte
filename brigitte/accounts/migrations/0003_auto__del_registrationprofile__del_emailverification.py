...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table('accounts_emailverification', (
            ('code', self.gf('django.db.models.fields.CharField')(default='df37de2b-1639-4224-a3eb-0a555c856782', max_length=40)),
            ...
            ('expiration_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 1, 20, 22, 44, 57, 570952))),
            ('is_expired', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('token', self.gf('django.db.models.fields.CharField')(default='3bfb2c0d-c2c4-43d8-b6b1-aa3645c3296e', max_length=40)),
